...
export default async function ComicPage({
  ...
  return (
    <div className="min-h-[100vh] py-unit-lg sm:px-unit-lg md:px-unit-xl  lg:px-unit-4xl gap-y-unit-lg  flex flex-col bg-default-50 ">
      ...
      <div className="flex lg:flex-row flex-col  gap-x-unit-2xl  mt-unit-md">
        ...
        <div className="flex gap-y-5 flex-col items-start">
          <h1 className=" drop-shadow-xl text-center text-3xl   text-wrap line-clamp-2 mt-unit-md md:text-5xl font-bold">
            {data.getComicBySlug.name || data.getComicBySlug.otherNames[0]}
          </h1>
          <div className="grid gap-y-2 comic-basic-info">
            ...
            <span className="ml-unit-md">
              {new Intl.NumberFormat("vi-VN").format(
                data.getComicBySlug.totalViewCount
              )}
            </span>
            <span className="">Theo dõi: </span>
            <span className="ml-unit-md">
              {new Intl.NumberFormat("vi-VN").format(
                data.getComicBySlug.followCount!
              )}
            </span>
          </div>
            ...
            <ButtonGroup size="lg">
              ...
              <Button
                ...
                href={`/truyen/${data.getComicBySlug.slug}/chuong/${
                  chaptersData.getAllChapters[
                    chaptersData.getAllChapters.length - 1
                  ]._id
                }?chuong=${
                  chaptersData.getAllChapters[
                    chaptersData.getAllChapters.length - 1
      ...
      <div>
        ...
        <ChapterView
          comic={data.getComicBySlug as Comic}
          chapters={chaptersData.getAllChapters as Chapter[]}
        />
      </div>
    </div>
  );
