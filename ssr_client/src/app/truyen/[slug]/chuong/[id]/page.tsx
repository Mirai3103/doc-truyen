...
export default async function DocTruyen({ params }: { params: { id: string; slug: string } }) {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <h1 className="text-3xl font-bold  pl-8">
                ...
                <span className="text-xl  italic font-light"> [cập nhật {toReadbleTime(chapter.createdAt)}]</span>
            </h1>
            <SelectChapter
